...
import com.compass.park.api.jwt.JwtUserDetails;
import com.compass.park.api.repository.projection.ClienteProjection;
import com.compass.park.api.service.ClienteService;
...
import com.compass.park.api.web.dto.PageableDto;
import com.compass.park.api.web.dto.UsuarioResponseDto;
import com.compass.park.api.web.dto.mapper.ClienteMapper;
import com.compass.park.api.web.dto.mapper.PageableMapper;
    ...
    @Operation(summary = "Criar um novo cliente", description = "Recurso para criar um novo cliente vinculado a um usuario cadastrado" +
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "409",
                            description = "Cliente CPF já registrado no sistema",
                            content = @Content(mediaType = "application/json;charset=UTF-8", schema = @Schema(implementation = ErrorMessage.class))),
                    @ApiResponse(responseCode = "422",
                            description = "Recurso não processado por entrada de dados invalidos",
                            content = @Content(mediaType = "application/json;charset=UTF-8", schema = @Schema(implementation = ErrorMessage.class))),
                    @ApiResponse(responseCode = "403",
                            description = "Recurso não permitido ao perfil ADMIN",
                            content = @Content(mediaType = "application/json;charset=UTF-8", schema = @Schema(implementation = ErrorMessage.class)))
            })
    @PostMapping
